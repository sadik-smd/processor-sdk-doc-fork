...
.. warning::
   ...
   If using a **SK-AM62B-P1** board, you must ensure the board has a 10kΩ resistor soldered at R6.
   Without this resistor, Wi-Fi from the CC33XX will not work correctly. For more info, see the CC33XX documentation:
